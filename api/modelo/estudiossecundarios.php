...
function InsertarEstudiosSecundarios(){
    ...
    try{
        ...
        $sql = "INSERT INTO ESTUDIOSSECUNDARIOS (ASPI_ID, INST_CODIGOSNP, ESSE_FECHATERMINACION, ESSE_SNP, ESSE_PUNTAJEOBTENIDO, ESSE_FECHAPRESENTOPRUEBAS, ESSE_FECHACAMBIO, ESSE_REGISTRADOPOR) VALUES(".$inscripcion->ASPI_ID.",'".$inscripcion->INST_CODIGOSNP."','".$inscripcion->ESSE_FECHATERMINACION_S."','".$inscripcion->ESSE_SNP."',".$inscripcion->ESSE_PUNTAJEOBTENIDO.",'".$inscripcion->ESSE_FECHAPRESENTOPRUEBAS_S."','".$fecha."','".$inscripcion->ASPI_NUMERODOCUMENTO."')";
